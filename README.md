...
| Vaca Romero David Octavio| Modelado UML, implementación de la trazabilidad mediante Traceability , verificación de funcionalidades de Enterprise Architect y validación del modelo de Edit Code Templet en video DEMO. |
--- 
